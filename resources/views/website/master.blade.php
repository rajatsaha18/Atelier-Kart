...
<head>
    ...
    <link href="{{asset('/')}}website/assets/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">
    <link rel="stylesheet" href="{{asset('/')}}website/assets/css/xzoom.css" media="all" />
    <link href="http://fonts.googleapis.com/css2?family=Hind+Siliguri:wght@300;400;500;600;700&amp;display=swap"
          rel="stylesheet">
    ...
    <div class="w3l_header_right w3-two-three-grids">
        <div class="product_list_header mx-lg-4">
            <div class="button mt-2">
                <a href="{{route('show-cart')}}" class="btn btn-primary">View Cart <i class="bi bi-cart4"></i></a>
            </div>
        </div>
        <ul>
                ...
                <div class="mega-dropdown-menu">
                    <div class="w3ls_vegetables">
                        ...
                        <ul class="dropdown-menu drp-mnu">
                            <li><a href=""><i class="bi bi-person"></i>Hello {{Session::get('customer_name')}}</a></li>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light p-lg-0">
                    <h1> <a class="navbar-brand" href="{{route('home')}}">
                            <span class="capw3">A</span>telier <span class="subcap">Kart</span>
                        </a></h1>
                    <ul class="navbar-nav mx-lg-auto mt-lg-0 mt-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('best-deals')}}">Best Deals</a>
                        </li>
...
<div class="footer">
    <div class="container">
        ...
        <div class="row agile_footer_grids">
            <div class="col-lg-3 col-sm-6 w3_footer_grid agile_footer_grids_w3_footer">
                <div class="w3_footer_grid_bottom">
                    ...
                    <img src="{{asset('/')}}website/assets/images/card.png" alt=" " class="img-fluid" />
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 w3_footer_grid agile_footer_grids_w3_footer">
                <div class="w3_footer_grid_bottom">
        ...
        <div class="wthree_footer_copy">
            <p>© 2021 Corner Store. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a>
            </p>
        </div>
    </div>
</div>
...
<script src="{{asset('/')}}website/assets/js/theme-change.js"></script>
<script>
...
<!-- js -->
<script src="{{asset('/')}}website/assets/js/jquery-1.11.1.min.js"></script>
<!-- //js -->
...
<script type="text/javascript" src="{{asset('/')}}website/assets/js/move-top.js"></script>
<script type="text/javascript" src="{{asset('/')}}website/assets/js/easing.js"></script>
<script type="text/javascript">
...
<!-- start-smoth-scrolling -->
<!-- flexSlider -->
<link rel="stylesheet" href="{{asset('/')}}website/assets/css/flexslider.css" type="text/css" media="screen" property="" />
<script defer src="{{asset('/')}}website/assets/js/jquery.flexslider.js"></script>
<script type="text/javascript">
...
<!-- //flexSlider -->
<script src="{{asset('/')}}website/assets/js/minicart.js"></script>
<script>
