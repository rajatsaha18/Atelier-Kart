...
@section('body')
    ...
    <script src="{{asset('/')}}admin/assets/js/export.min.js"></script>
        ...
        <div class="mid-content-top charts-grids">
            <div class="middle-content">
                ...
                <div id="owl-demo" class="owl-carousel text-center">
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('/')}}admin/assets/images/slider1.jpg" alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('/')}}admin/assets/images/slider2.jpg" alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('/')}}admin/assets/images/slider3.jpg" alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('/')}}admin/assets/images/slider4.jpg" alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('/')}}admin/assets/images/slider5.jpg" alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('/')}}admin/assets/images/slider6.jpg" alt="name">
                    </div>
                    <div class="item">
                        <img class="lazyOwl img-responsive" data-src="{{asset('/')}}admin/assets/images/slider7.jpg" alt="name">
                    </div>
            ...
            <div class="activity_box">
                ...
                <div class="scrollbar" id="style-1">
                    <div class="activity-row">
                        <div class="col-xs-3 activity-img"><img src='{{asset('/')}}admin/assets/images/1.jpg' class="img-responsive" alt=""/></div>
                    ...
                    <div class="activity-row">
                        <div class="col-xs-3 activity-img"><img src='{{asset('/')}}admin/assets/images/4.jpg' class="img-responsive" alt=""/></div>
                        <div class="col-xs-7 activity-desc">
                    ...
                    <div class="activity-row">
                        <div class="col-xs-3 activity-img"><img src='{{asset('/')}}admin/assets/images/3.jpg' class="img-responsive" alt=""/></div>
                        <div class="col-xs-7 activity-desc">
                    ...
                    <div class="activity-row">
                        <div class="col-xs-3 activity-img"><img src='{{asset('/')}}admin/assets/images/2.jpg' class="img-responsive" alt=""/></div>
                        <div class="col-xs-7 activity-desc">
            ...
            <div class="activity_box activity_box1">
                ...
                <div class="scrollbar" id="style-3">
                    <div class="activity-row activity-row1">
                        <div class="col-xs-3 activity-img"><img src='{{asset('/')}}admin/assets/images/1.jpg' class="img-responsive" alt=""/><span>06:01 AM</span></div>
                    ...
                    <div class="activity-row activity-row1">
                        ...
                        <div class="col-xs-3 activity-img"><img src='{{asset('/')}}admin/assets/images/3.jpg' class="img-responsive" alt=""/><span>06:02 AM</span></div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="activity-row activity-row1">
                        <div class="col-xs-3 activity-img"><img src='{{asset('/')}}admin/assets/images/1.jpg' class="img-responsive" alt=""/><span>06:05 AM</span></div>
                        <div class="col-xs-5 activity-img1">
                            <div class="activity-desc-sub">
                                <h5>Michael Chris</h5>
                    ...
                    <div class="activity-row activity-row1">
                        ...
                        <div class="col-xs-3 activity-img"><img src='{{asset('/')}}admin/assets/images/3.jpg' class="img-responsive" alt=""/><span>06:20 PM</span></div>
                        <div class="clearfix"> </div>
                    </div>
                </div>
                <form action="#" method="post">
