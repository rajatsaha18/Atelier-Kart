...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/06-01-2018/glance_design_dashboard-demo_Free/215073379/web/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Aug 2022 04:19:08 GMT -->
            ...
            <div class="sign-up-row widget-shadow">
                ...
                <form action="{{route('register')}}" method="POST">
                    ...
                    <div class="sign-u">
                        ...
                        <input type="password" placeholder="Confirm Password"  name="password_confirmation" required="required">
                    </div>
                ...
                <h5><a href="{{route('dashboard')}}">Go Back To Home</a></h5>
            </div>
        </div>
    </div>
    <!---728x90--->
