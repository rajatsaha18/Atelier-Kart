...
@section('body')
    ...
    <div class="invoice-box">
        <table>
            ...
            <tr class="item">
                <td  >{{$orderDetail->product_name}} <img src="{{asset($orderDetail->product_image)}}" alt="" height="40" width="30"></td>
            ...
            <tr class="total">
                <td></td>
                <td colspan="3">SubTotal:{{number_format($sum)}}</td>
            </tr>
            @php($tax = round((($sum*15)/100)))

            <tr class="total">
                <td></td>
                <td colspan="3">TaxTotal:{{$tax}}</td>
            </tr>

            <tr class="total">
                <td></td>
                <td colspan="3">ShippingTotal:{{$order->shipping_total}}</td>
            </tr>

            <tr class="total">
                <td></td>
                <td colspan="3">Total Payable:{{number_format($sum+$tax+$order->shipping_total)}}</td>
            </tr>
        </table>
    </div>
